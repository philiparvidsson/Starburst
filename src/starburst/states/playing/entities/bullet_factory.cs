...
using Fab5.Engine;
    ...
    static System.Random rand = new System.Random();
        ...
        private static float shipRadian = 23f; // offset från skeppets mitt där skottet utgår ifrån
        private static float speed = 500f; // skottets hastighet (kanske ska vara vapenberoende?)
        private static float lifeTime = 1f; // skottets livstid (i sekunder? iaf baserad på dt)
        public static Component[] create_components(Position position, Angle shipAngle, Weapon weapon) {
            ...
            Sprite bulletSprite = new Sprite() { texture = bulletTexture, layer_depth = 1, blend_mode = Sprite.BM_ADD };
